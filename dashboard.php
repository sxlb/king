...
<div class="joe-dashboard-header"><h1 class="joe-dashboard-header__title">数据看板</h1><p class="joe-dashboard-header__desc">站点运行状态与内容分析</p></div>
            ...
            <div class="joe-dashboard-cards">
                ...
                <div class="joe-dashboard-card">
                    ...
                    <div class="joe-dashboard-card__body">
                        <div class="joe-dashboard-card__value"><?php echo number_format($stats['views'] ?? 0); ?></div>
            ...
            <div class="joe-dashboard-row">
                <div class="joe-dashboard-section joe-card">
                    ...
                    <div class="joe-dashboard-bars">
                        <?php foreach ([
                            ['label' => '文章', 'value' => $stats['posts'] ?? 0, 'color' => 'var(--primary)'],
                            ['label' => '页面', 'value' => $stats['pages'] ?? 0, 'color' => '#1abc9c'],
                            ['label' => '分类', 'value' => $stats['categories'] ?? 0, 'color' => '#f39c12'],
                            ['label' => '标签', 'value' => $stats['tags'] ?? 0, 'color' => '#9b59b6'],
                        ] as $item): 
                ...
                <div class="joe-dashboard-section joe-card">
                    ...
                    <div class="joe-dashboard-list">
                        ...
                        <a href="<?php echo joe_esc($this->options->siteUrl . '/index.php/archives/' . $hp['slug'] . '/'); ?>" class="joe-dashboard-list__item">
                            ...
                            <span class="joe-dashboard-list__stat">💬 <?php echo (int)($hp['commentsNum'] ?? 0); ?></span>
                        </a>
                        <?php endforeach; ?>
                    </div>
                </div>
